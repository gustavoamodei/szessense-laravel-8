...
<div class="container">
    <div class=" pt-4  col-12">
        ...
        <a href="{{route('acessorio.create')}}" class="btn btn-success mb-3">Cadastrar</a>
        ...
        <table class=" table table table-bordered table-hover" id="table_acessorio">
            ...
            <tbody>
                   ...
                   <tr>
                        ...
                        <td>{{ number_format($acessorio->preco, 2 , ",", "."); }}</td>
                        <td>{{ $acessorio->descricao }}</td>
                        <td>
                            <a href="{{route('acessorio.edit',$acessorio->id )}}" class="btn btn-primary">Editar</a>
        ...
        $.ajax({
                ...
                success:function(){
                    $('#alert_red').html( 
                        ...
                        acessorio Deletado com sucesso!!
