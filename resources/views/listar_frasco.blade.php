...
<div class="container">
    <div class=" pt-4  col-12">
        ...
        <a href="{{route('frasco.create')}}" class="btn btn-success mb-3">Cadastrar</a>
        ...
        <table class=" table table table-bordered table-hover" id="table_frasco">
            ...
            <tbody>
                   ...
                   <tr>
                        <td>{{$frasco->id}}</td>
                        <td>{{$frasco->nome}}</td>
                        <td>{{ number_format($frasco->preco, 2 , ",", "."); }}</td>
                        <td>{{ $frasco->descricao }}</td>
                        <td>
                            <a href="{{route('frasco.edit',$frasco->id )}}" class="btn btn-primary">Editar</a>
