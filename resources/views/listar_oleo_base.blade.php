...
<div class="container">
    <div class=" pt-4  col-12">
        ...
        <a href="{{route('oleo_base.create')}}" class="btn btn-success mb-3">Cadastrar</a>
        ...
        <table class=" table table table-bordered table-hover" id="table_ob">
            ...
            <tbody>
                   ...
                   <tr>
                        ...
                        <td>{{ $ob->validade }}</td>
                        <td>
                            <a href="{{route('oleo_base.edit',$ob->id )}}" class="btn btn-primary">Editar</a>
